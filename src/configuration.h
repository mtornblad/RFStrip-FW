...
//#define APP_INTERFACE APP_INTERFACE_USBCDC
...
// Shall be used to select an explicit antenna in case Antenna Diversity not
// enabled on the board which supports Antenna Diversity. Not applicable for
// BOARD_SAMR21_XPRO Board.
#define BSP_ANTENNA_SELECTED 1
//#define BSP_ANTENNA_SELECTED 2
